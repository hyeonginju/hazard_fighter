...
| 긴급재난문자 (safetydata.go.kr) | ✅ 발급 완료 (2026-07-20) | `.env`의 `SAFETYDATA_API_KEY`. 실응답 스펙 확인됨(DSSP-IF-00247). ingestion 클라이언트는 미구현 — **일일 한도 1,000건으로 타 소스(10,000)의 1/10이라 폴링 주기 설계 주의** |
